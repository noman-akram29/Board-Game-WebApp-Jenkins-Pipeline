pipeline {
    ...
    stages {
        ...
        stage('Deploy to Kubernetes'){
            steps{
                withKubeConfig(caCertificate: '', clusterName: 'kubernetes', contextName: '', credentialsId: 'K8s-Creds', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://172.31.40.106:6443') {
